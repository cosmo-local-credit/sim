...
class ScenarioConfig:
    ...
    affinity_buddy_min_count: int = 1  # use known buddies once at least this many exist
    ...
    noam_clearing_include_clc: bool = False
    ...
    lender_voucher_purchase_attempts_per_tick: int = 0
    lender_voucher_purchase_consumer_share: float = 0.75
    lender_voucher_purchase_max_target_candidates: int = 5
    ...
    bond_service_lockbox_mode: str = "next_due"
    bond_service_lockbox_coverage_ratio: float = 1.0
